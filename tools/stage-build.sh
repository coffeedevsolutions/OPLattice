...
SHELF_SENTINELS=(libDrawAlphabet LIB_ALPHA_LABELS RAIL_ICON_W shelfSyncFonts shelfHint shelfRenderInfo infDrawButton homeDateOk INF_DESC_Y METACRITIC COVXL LIB_FTR_H_DRAWN libMetaGet configFree)
