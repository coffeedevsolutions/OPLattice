...
ELF=$B/OPNPS2LD.ELF
PATCH_SENTINELS=(rmSetPanX shelfPushX menuGetActiveList ELEM_TYPE_ATTRIBUTE_LIST rmDrawGradV oplRecentPrune MENU_CHEAT_SETTINGS forceGlobalCheat ENOENT)
SHELF_SENTINELS=(libDrawAlphabet LIB_ALPHA_LABELS RAIL_ICON_W shelfSyncFonts shelfHint shelfRenderInfo infDrawButton homeDateOk INF_DESC_Y METACRITIC COVXL LIB_FTR_H_DRAWN libMetaGet configFree libBuildSections libJumpSection)
