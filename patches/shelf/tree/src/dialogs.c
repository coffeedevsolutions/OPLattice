...
struct UIItem diaConfig[] = {
    ...
    /* Sits under Write Operations because it cannot function without it, and is
     * hidden rather than greyed when that is off -- dia has no disabled state.
     * Literal label: adding a localised string would mean regenerating every
     * language file for a feature that is still a minimal core. */
    {UI_LABEL, CFG_LBL_PLAYSTATS, 1, 1, -1, -40, 0, {.label = {"Play Stats", -1}}},
    {UI_SPACER},
    {UI_BOOL, CFG_PLAYSTATS, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},

    {UI_LABEL, 0, 1, 1, -1, -40, 0, {.label = {"SHELF UI", -1}}},
    {UI_SPACER},
    {UI_BOOL, CFG_SHELFUI, 1, 1, -1, 0, 0, {.intvalue = {0, 0}}},
    {UI_BREAK},
